...
public class UserInfoDaoImpl implements UserInfoDao {
    ...
    public void addUser(UserInfo user) throws Exception {
        ...
        qr.update("insert user_information(ID,password,realName,birthday,gender,phone,Equip_ID) VALUES(?,?,?,?,?,?,?)",user.getID(),user.getPassword(),user.getRealName(),user.getBirthday(),user.getGender(),user.getPhone(),user.getEquip_ID());
    }
